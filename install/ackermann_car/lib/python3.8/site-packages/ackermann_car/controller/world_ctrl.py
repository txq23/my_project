...
class WorldController(Node):
    def __init__(self):
        ...
        self.chair_pub = self.create_publisher(Twist, '/chair/cmd_vel', qos)
        self.cart_pub = self.create_publisher(Twist, '/cart/cmd_vel', qos)
    ...
    def control_callback(self):
        try:
            ...
            # === 推车控制（保持原逻辑） ===
            cart_cmd = Twist()
            cart_cmd.linear.x = 1.0
            cart_cmd.angular.z = 0.8
